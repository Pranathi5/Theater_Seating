...
import com.model.TheaterSection;

public class TheaterSeatingUtil {

public TheaterLayout constructTheaterLayout(String rawLayout) throws Exception{
    ...
    public List<TheaterRequest> constructListOfTicketRequest(String ticketRequestsList) throws Exception{
        
        List<TheaterRequest> requestsList = new ArrayList<TheaterRequest>();
        TheaterRequest request;
        
        String[] requests = ticketRequestsList.split(System.lineSeparator());
